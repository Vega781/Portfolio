            ...
            <footer className={styles.footer}>
                <div className={styles.footer__container}>
                    <div className={styles.footer__left}>
                        <a href={socialLinks.fakecrime} target='_blank'>
                            <GradientText text='Follow me' />
                        </a>
                    </div>
                    <div className={styles.footer__right}>
                        <a href={socialLinks.github} className={styles.social__link} target='_blank'>
                            <svg className={styles.link__svg} width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href={socialLinks.telegram} className={styles.social__link} target='_blank'>
                            <svg className={styles.link__svg} width="20" height="21" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href={socialLinks.email} className={styles.social__link} target='_blank'>
                            <svg className={styles.link__svg} width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={styles.footer__copyright}>{`Vega7 © ${currentDate}`}</span>
            </footer>
        </>
    )
}