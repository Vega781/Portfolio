        ...
        <header className={styles.header}>
            <div className={styles.header__container}>
                ...
                <nav className={styles.social__links}>
                    <a href={socialLinks.github} className={styles.social__link}>
                    ...
                    <a href={socialLinks.telegram} className={styles.social__link}>
                    ...
                    <a href={socialLinks.hexlet} className={styles.social__link}>
                        <svg width="20" height="21" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="16" cy="16" r="14" fill="#B292FF" />
                    ...
                    <a href={socialLinks.email} className={styles.social__link}>
